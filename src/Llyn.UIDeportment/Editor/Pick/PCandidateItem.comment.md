...
The id is what the chip will carry.
Choosing a row attaches the stored Situation rather than a copy of its words.
...
A match under a culture's rules is not always as long as the wording that found it.
A wording the typing does not appear in is held whole in the first piece.
