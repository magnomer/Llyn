...
public partial class PGuild
{
    ...
    {
        return _pAutographTenure?.LTenureChangeCheck() ?? false;
    }
    ...
    private bool PAutographStoreRun()
    {
        ...
        _pAutographTenure = null;
        long? shown = _pGuildVista?.LVistaStored;
    ...
    private void PAutographUnionHandle(object sender, TextChangedEventArgs e)
    {
        ...
        {
            if (vista.LVistaMatch(row.LCatalogAuthorStored.LAuthorId))
            {
                continue;
            }
    ...
    private void PAutographUnionSelect(object sender, RoutedEventArgs e)
    {
        ...
        if (_pGuildVista?.LVistaStored is not long dropped)
        {
            return;
        }
    ...
    {
        if (_pGuildVista?.LVistaStored is not long id)
        {
            return;
        }
