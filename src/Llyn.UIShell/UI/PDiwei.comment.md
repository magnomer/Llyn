...
The sections list the placements by division, each row a rime and its characters.
Under each division heading the tally lines print, one per borrowing language and kind of reading.
...
A switch at the right end of every division heading picks IPA or respelling for those lines.
