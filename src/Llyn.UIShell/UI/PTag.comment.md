...
The list panel asks for an entry by its headword.
...
The list panel's sorting mark is left-aligned, so the two panels are told apart at a glance.
...
The same entry actions the list panel offers, over the same reader.
