...
The four ladder names from the lowest rung up, so a name's position plus one is its star count.
The names are the engine's own, fixed by [LFrequency](../../Llyn.Core/Pronunciation/LFrequency.comment.md).
