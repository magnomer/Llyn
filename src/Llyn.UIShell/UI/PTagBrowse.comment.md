...
Browsing behavior of the tag panel.
...
This is the same read half of the entry round trip the list panel offers, reached through a tag instead of a headword.
...
### `private void PTagHandle(object sender, DependencyPropertyChangedEventArgs e)`
