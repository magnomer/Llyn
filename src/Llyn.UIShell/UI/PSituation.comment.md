...
`PSituationFresh` opens the editor on a Situation nothing references yet.
...
What it shares with the entry panels is the read-and-edit mechanism and the `PSituationScribe` toggle, not the object.
