...
## `public sealed class TMentionFind`
...
Japanese text picks the longest headword covering the click over the letter run, and falls back to the run where nothing matches.
