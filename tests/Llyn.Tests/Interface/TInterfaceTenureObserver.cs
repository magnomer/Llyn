...
{
    internal static void TTenureObserverAttach(this LTenure tenure, LSubject subject, LObserver observer) =>
        tenure.LTenureObserverAttach(subject, observer);

    internal static void TTenureDraftAttach(this LTenure tenure, LSubject subject, LObserver observer) =>
        tenure.LTenureDraftAttach(subject, observer);

    internal static void TTenureEntryAttach(this LTenure tenure, LSubject subject, LObserver observer) =>
